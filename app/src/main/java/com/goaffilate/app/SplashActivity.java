...
//    com.goaffilate.app.utils.GifImageView gifImageView;
...
//        gifImageView.setGifImageResource(R.drawable.spgif);
   ...
   if(session_management.isLoggedIn()) {
    ...
    startActivity(startmain);
            ...
            Intent startmain = new Intent(SplashActivity.this, SlideActivity.class);
            startActivity(startmain);
        }
        finish();
    }
